...
.controller('login_ctrl', function($scope, $http, $location) {
			...
			var passmd5 = (MD5($scope.password));
		   	...
		   	$http.post("http://localhost:8101/user_exists?Email="+$scope.email+"&Password="+passmd5
	        	...
	        	if (response.data.$ == false) {
	        		...
	        		$http.post("http://localhost:8101/retrieve_client_info_from_email?Email="+$scope.email).then(function(response) {
						// dati della session
