...
interface microservices_dbInterface {
	RequestResponse:
		...
		retrieve_client_interface_by_id(msid)(Info_Interf),
		homepage_ms_list(void)(home_ms_list),
		retrieve_ms_info( msid )( msdata ),
		retrieve_intf_info( intfid )( intfdata ),
		retrieve_ms_by_developerId(devid)(list_ms_id),
		retrieve_interfaces_of_ms( msid )( listinterfaces ),
